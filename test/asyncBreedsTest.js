...
describe('#breedDetailsFromFile', () => {
  ...
  it('provides, via callback, breed details for the Balinese breed', (done) => {
    breedDetailsFromFile('Balinese', (balinese) => {
      let expectedDesc = "Balinese are curious, outgoing, intelligent cats with excellent communication skills. They are known for their chatty personalities and are always eager to tell you their views on life, love, and what you’ve served them for dinner.";
      assert.equal(expectedDesc, balinese);
       done();
    });
  });

  it('returns no  details for incorrect breed', (done) => {
    breedDetailsFromFile('bolinese', (notFound) => {
